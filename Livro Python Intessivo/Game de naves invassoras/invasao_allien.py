...
while True:
    ...
    if stats.game_active:
        ...
        gf.update_aliens(ai_settings, stats, screen, ship, aliens, bullets) #Chama o metodo para atualizar a posição dos aliens dentro do grupo aliens
        #E controlar o numero de vidas e reconstruir a frota alien quando ela atingir a nave
    gf.update_screen(ai_settings, bg_color, screen, stats, ship, aliens, bullets, play_button) #aqui atualizo a tela com os objetos
