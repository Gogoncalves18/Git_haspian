...
def contador(*num):
    # O * permite definir para o Python que eu receberei varios
    # parametros
...
# Para uso de funcoes, recomendasse colocar no inicio do programa
# e PULAR 2 linhas para iniciar o programa principal
...
print(lst_val)  # lista original que acabou sendo impactada pela funcao
# porque o objeto ficou referenciado

# Tratamento de lista em funcao sem referenciar os objetos de uma
# lista para outra
lst_val2 = [2, 6, 4, 8]  # Lista original
print('\nLINHA 55 e 56')
dobra2(lst_val2)  # lista retrabalhada pela funcao
print(f'A lista original manteve {lst_val2}')
# lista original que acabou sendo impactada pela funcao porque o
# objeto ficou referenciado
