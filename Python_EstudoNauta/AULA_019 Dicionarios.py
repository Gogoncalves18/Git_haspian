...
print(f'\n{cadastro}')
print(f'\nLINHA 28 - O {cadastro[1]["nome"]} tem {cadastro[1]["idade"]} anos.')
...
#Rodar apenas as keys que estao dentro de um dict que esta dentro de uma list:
for i in cadastro:
...
for c in range(0,3):
    ...
    cadastro.append(dados.copy()) #necessario fazer a copiada do 
                                    #dict para dentro da lista em
                                    #cada laco para nao sobreesrever
