...
"""
print('\n\033[1;30;42m{:<16}{:^30}{:>16}\033[m'.format('-_-'*15,' CADASTRO DE PESSOAS ','-_-'*15))
sexo=''
idade=0
    ...
    if sair_prog == False:
        ...
        while True: #teste para validar a entrada de idade apenas em numero
            try:
                ...
                print(f'Digite apenas um valor inteiro numeral!')
            else:
                break
        while True: #Teste para validar o sexo
            sexo=str(input('Sexo [M] ou [F]: ')).upper()[0]
            if sexo not in 'MF':
                print('Digite apenas \033[1;32m{}\033[m ou \033[1;32m{}\033[m'.format('M','F'))
            else:
...
''')
print('\n\033[1;30;41m{:<16}{:^30}{:>16}\033[m'.format('-_-'*15,' FIM ','-_-'*15))
print("")
