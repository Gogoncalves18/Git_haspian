...
# ue 20 anos e qual o nome e idade do homem mais velho
idade_media = int(0)
h_velho = int()
...
for n_person in range(1, 5):
    ...
    while True:
        ...
        except ValueError:  # SE ELE VOLTAR COM ERRO POR NAO SER INT,
            # EU EXECUTO
    ...
    while True:  # TESTE A ENTRADA SE E M OU F
        sexo = str(input('Insira o sexo da pessoa, "M" para homens\
e "F" para mulheres: ')).upper()[0]
        if sexo == 'M' or sexo == 'F':
            if sexo == 'M':
                if idade > h_velho:
                    h_velho = idade
...
print('\nA media de idade do grupo e de {} Anos!'
      .format(idade_media/n_person))
print('\nO homem mais velho e {}, com idade de {}anos.'
      .format(nome_mais_velho, h_velho))
print('\nNeste grupo ha {} mulheres com idade menor que 20 anos.'
      .format(f_menos_20_anos))
