# Devemos percorrer os 10 melhores times posicionados, apresentar
# os 3 primeiros, os dois ultimos e a ordem alfabetica

rank_dos10 = ('gremio', 'palmeiras', 'flamengo', 'corinthias',
              'atletico/MG', 'internacional', 'santos', 'cruzeiro',
              'bahia', 'fluminense')
print('')
print('-_-'*40)
