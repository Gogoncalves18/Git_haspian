...
lst = fr.split()
print('Seu primeiro nome e {} e ele possui {} letras!'
      .format(lst[0].upper(), fr.find(' ')))  # Esta ultima formatacao
# pega o comprimento até o espaco, se nao tiver, ele retorna -1
