...
print('\n{:<15}{:^20}{:>15}'
      .format('-_-' * 10, 'MENU DE OPCOES PARA OPERADORES', '-_-'*10))
print('''
    [1] Somar
    [2] Multiplicar
    [3] Maior
...
while True:
    ...
    if opcao_user > 5 or opcao_user < 1:
        ...
        print('\nA soma dos de {} e {} tem resultado {}.'
              .format(num_1, num_2, (num_2 + num_1)))
    elif opcao_user == 2:
        print('\nA mutiplicacao de {} com {} tem resultado {}.'
              .format(num_1, num_2, (num_2 * num_1)))
    elif opcao_user == 3:
        maior_num = num_1
        if maior_num < num_2:
            maior_num = num_2
        print('\nO maior numero entre {} e {} é {}.'
              .format(num_1, num_2, maior_num))
    elif opcao_user == 4:
