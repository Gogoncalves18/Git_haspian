...
def votos(ano):  # funcao que recebe o ano de nascimento
    ...
    if ano_atual - ano > 18 and ano_atual - ano <= 60:
        # retorno da funcao para quem deve voltar
        return '\nSeu voto é obrigatorio !'
    elif ano_atual - ano > 60:
        # retorno da funcao para que não vota mais
        return '\nTu é velho, vai dormir!!!'
    elif ano_atual - ano < 18:  # retorno para quem é menor de idade
        return '\nVai aprender a se limpar direito pirralho!'


# PROGRAMA PRINCIPAL
print(votos(int(input('\nEm que ano vc nasceu: '))))
# Chamada da funcao com input para o terminal
