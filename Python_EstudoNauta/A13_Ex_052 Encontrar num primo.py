...
for c in range(1, num_in + 1):
    ...
    if num_in % c == 0:
        ...
        print(c, end=' ')
if qtd_div == 2:
    print('\nNo numero digitado temos apenas \033[1;33;40m{} {}\033[m que sao \
          primos de {}!'.format(qtd_div, 'Numeros AMARELO', num_in))
else:
    print('\nNo numero digitado temos apenas \033[1;33;40m{} {}\033[m\
           que NAO sao primos de {}!'.format(qtd_div, 'Numeros AMARELO',
                                             num_in))
