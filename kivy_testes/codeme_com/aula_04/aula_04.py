...
class Meu_grid(GridLayout): 
    def __init__(self, **kwargs):
        ...
        #o ROW_FORCE_DEFAULT = TRUE faz com que eu posso definir uma altura para 
        #linha do grid, assim posso usar também um controle de largura com o
        #COL_FORCE_DEFAULT
        ...
        #Definição de tamanho em x e y do widget inserido
