def diagonais_direita(res_diagonal: list):
                                ...
                                if col == 0 and linha == 0:
                                    ...
                                    try:
                                        ...
                                        try:
                                            ...
                                            if num_jogada_anterior + 11 in diagonal:
                                                seq_diagonal += 1
                                                match_diagonal = False
                                                linha += 1
                                                col += 1
...
res_diagonal = [
                ...
                (2, 3, 4, 5, 10, 11, 12, 14, 17, 19)
                ]

filtro_direita = diagonais_direita(res_diagonal)
for diagonais_filtradas_d in filtro_direita:
    if diagonais_filtradas_d:
        print(diagonais_filtradas_d)